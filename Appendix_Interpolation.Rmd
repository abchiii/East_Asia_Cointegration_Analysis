...
yearly_data <- read_excel("/Users/chingting/Desktop/research_revision copy/yearly_data.xlsx") 
yearly_data$Date <- as.Date(yearly_data$...1)
attach(yearly_data)
...
write.csv(df, "interpolated_data.csv")
